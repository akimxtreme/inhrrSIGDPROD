...
<title>Buscar Usuario a Eliminar</title>
<!-- InstanceEndEditable -->
...
echo '<h1 class="tituto_tipo_documento">Búsqueda de Usuario (Eliminar)</h1>';	
echo '</div>';
	...
	$seleccion=mysql_query($sql,$conexion);
 	$cantidad_de_registros = 1;
				while ($row = mysql_fetch_array($seleccion)){
						...
						<td class="codigo">
							<form action="eliminar_usuario.php" method="post" name="eliminar" id="">
							<input type="hidden" name="eliminar_usuario" id="" value="'. $campo_1 .'" />
							<button type="submit" name="eliminar" id="" value="eliminar">Eliminar</button>
							</form>
						</td>
						</tr>';
