...
<title>Buscar Unidad a Eliminar</title>
<!-- InstanceEndEditable -->
...
echo '<h1 class="tituto_tipo_documento">Búsqueda de Unidad - (Eliminar)</h1>';	
echo '</div>';
	...
	$seleccion=mysql_query($sql,$conexion);
 	$cantidad_de_registros = 1;
				while ($row = mysql_fetch_array($seleccion)){
						...
						<td class="evaluar">
							<form action="eliminar_unidad.php" method="post" name="eliminar_unidad" id="">
							<input type="hidden" name="unidad_eliminar" id="" value="'. $campo_1 .'" />
							<button type="submit" name="eliminar_unidad" id="" value="eliminar_unidad">Eliminar Unidad</button>
							</form>
						</td>
						</tr>';
