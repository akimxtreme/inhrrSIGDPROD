...
<title>Buscar Criterio a Modificar</title>
<!-- InstanceEndEditable -->
...
echo '<h1 class="tituto_tipo_documento">Búsqueda Criterio - (Modificación)</h1>';	
echo '</div>';
...
if($buscar == 'buscar'){
	...
	$seleccion=mysql_query($sql,$conexion);
				...
				while ($row = mysql_fetch_array($seleccion)){
						...
						<td class="codigo">
							<form action="modificar_criterio.php" method="post" name="modificar_criterio" id="">
							<input type="hidden" name="modif_criterio" id="" value="'. $campo_1 .'" />
							<button type="submit" name="modificar_criterio" id="" value="modificar_criterio">Modificar</button>
							</form>
						</td>
						</tr>';
