...
<title>Buscar Tipo de Documento a Eliminar</title>
<!-- InstanceEndEditable -->
...
echo '<h1 class="tituto_tipo_documento">Búsqueda Tipo de Documento - (Eliminar)</h1>';	
echo '</div>';
...
formulario_inicio ("Buscar Tipo de Documento","formulario","busqueda","","POST","consultaTipoDoc(this);","","","","");
	select ("Buscar por","formulario","buscar_tipodoc","","","buscar_tipodoc","","");
	text ("Ingrese","formulario","campo","campo","","","","","","","");	
	...
	$seleccion=mysql_query($sql,$conexion);
 	$cantidad_de_registros = 1;
				while ($row = mysql_fetch_array($seleccion)){
						...
						<td class="evaluar">
							<form action="eliminar_tipodoc.php" method="post" name="eliminar_tipodoc" id="">
							<input type="hidden" name="tipodoc_eliminar" id="" value="'. $campo_1 .'" />
							<button type="submit" name="eliminar_tipodoc" id="" value="eliminar_tipodoc">Eliminar Tipo de Documento</button>
							</form>
						</td>
						</tr>';
