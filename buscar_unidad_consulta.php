...
echo '<h1 class="tituto_tipo_documento">Búsqueda de Unidad</h1>';	
echo '</div>';
	...
	$seleccion=mysql_query($sql,$conexion);
 	$cantidad_de_registros = 1;
				while ($row = mysql_fetch_array($seleccion)){
						...
						<td class="evaluar">
							<form action="consultar_unidad.php" method="post" name="consultar_unidad" id="">
							<input type="hidden" name="unidad_consultar" id="" value="'. $campo_1 .'" />
							<button type="submit" name="consultar_unidad" id="" value="consultar_unidad">Consultar Unidad</button>
							</form>
						</td>
						</tr>';
