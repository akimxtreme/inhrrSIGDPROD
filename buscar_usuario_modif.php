...
<title>Buscar Usuario a Modificar</title>
<!-- InstanceEndEditable -->
...
echo '<h1 class="tituto_tipo_documento">Búsqueda de Usuario - (Modificación)</h1>';	
echo '</div>';
	...
	$seleccion=mysql_query($sql,$conexion);
 	$cantidad_de_registros = 1;
				while ($row = mysql_fetch_array($seleccion)){
						...
						<td class="codigo">
							<form action="modificar_usuario.php" method="post" name="modificar_usuario" id="">
							<input type="hidden" name="usuario_modificar" id="" value="'. $campo_1 .'" />
							<button type="submit" name="modificar_usuario" id="" value="modificar_usuario">Modificar</button>
							</form>
						</td>
						</tr>';
